...
procedure TfrmMainIosIcon.Button17Click(Sender: TObject);
var
  path:string;
...
begin
  ...
  fn := path + 'FM_ApplicationIcon_57x57.png';
  newfn := path + 'Icon.png';

  CopyFile(PChar(fn), PChar(newfn), False);

  //--------------------------------------------------

  fn := path + 'FM_ApplicationIcon_114x114.png';
  newfn := path + 'Icon@2x.png';

  CopyFile(PChar(fn), PChar(newfn), False);

  //--------------------------------------------------

  fn := path + 'FM_ApplicationIcon_120x120.png';
  newfn := path + 'Icon-120.png';
